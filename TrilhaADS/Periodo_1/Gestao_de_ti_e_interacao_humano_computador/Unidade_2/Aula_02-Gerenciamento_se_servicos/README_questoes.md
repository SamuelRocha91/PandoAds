...
### **1. Qual das opções abaixo descreve corretamente o conceito de SLA (Service Level Agreement) no gerenciamento de serviços de TI?**
...
### **2. Em termos de gerenciamento da qualidade de serviços de TI, qual fator é mais diretamente relacionado à percepção do usuário sobre a eficiência do serviço?**
...
### **3. Qual é o principal objetivo do gerenciamento de processos em uma organização de TI?**
...
### **4. No contexto do ITIL, qual é o principal objetivo do processo de **Gerenciamento de Incidentes**?**
...
### **5. Qual processo ITIL está diretamente envolvido em garantir que novos serviços ou mudanças em serviços existentes sejam entregues com qualidade e atendam às necessidades do cliente?**
...
### **6. O processo de **Gerenciamento de Problemas** no ITIL tem como foco principal:**
...
### **7. O que é um **Request for Change (RFC)** no processo de Gerenciamento de Mudanças do ITIL?**
...
### **8. Qual é o objetivo do processo de **Gerenciamento de Nível de Serviço** no ITIL?**
...
### **9. No processo de **Gerenciamento de Configurações** no ITIL, qual é a função da **CMDB (Configuration Management Database)**?**
...
### **10. Qual dos domínios do COBIT é responsável por estabelecer os pontos estratégicos para o uso da TI na organização, incluindo o planejamento dentro da perspectiva global dos riscos e setores da empresa?**
...
### **11. O domínio de **Aquisição e Implementação** no COBIT tem como principal objetivo:**
...
### **12. Qual é a principal função do domínio de **Entrega e Suporte** no COBIT?**
...
### **13. Qual dos seguintes domínios do COBIT é responsável pela **auditoria e monitoramento** contínuos dos processos e serviços de TI?**
...
### **14. No contexto do COBIT, o que é abordado pelo domínio de **Planejamento e Organização**?**
...
### **15. O **Plano Diretor de Informática (PDI)** é um elemento associado a qual domínio do COBIT?**
...
### **16. Qual é o principal objetivo da norma ISO/IEC 20000?**
...
### **17. Um dos benefícios da implementação da ISO/IEC 20000 é:**
...
### **18. De acordo com Magalhães e Pinheiro (2007), o Gerenciamento de Serviços de TI visa:**
...
### **19. Qual é a principal abordagem da **ITIL** no contexto do Gerenciamento de Serviços de TI?**
...
### **20. O que caracteriza o modelo de contratação **multisourcing** mencionado por Magalhães e Pinheiro (2007)?**
